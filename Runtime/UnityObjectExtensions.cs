...
namespace StrongExtensions
{
	public static class UnityObjectExtensions
	{
		...
		public static TObject Instantiate<TObject>
			(this TObject value, Vector3 position, Quaternion rotation, Transform parent) where TObject : Object =>
			Object.Instantiate(value, position, rotation, parent);

		public static TObject Instantiate<TObject>
			(this TObject value, Vector3 position, Transform parent) where TObject : Object =>
			Object.Instantiate(value, position, Quaternion.identity, parent);

		public static TObject Instantiate<TObject>(this TObject value, Vector3 position) where TObject : Object =>
